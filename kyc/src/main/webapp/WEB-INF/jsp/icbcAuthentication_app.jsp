...
<body class="login tooltips" style=" background: #ECECEC;">
	...
	<div class="login-header text-center"
		style="background: #A40000;color:#fff;height:64px;">
		<span
			style="font-size:22px;padding-top:5px;line-height:62px;font-style:"">ICBC</span>
	</div>
	<div class="login-wrapper" style="margin:115px auto 0">
		<form role="form">
			...
			<div class="form-group">
				<div style="margin-left:10%;margin-right:10%;margin-top:40px;">
					<button type="button" class="btn btn-block"
						style="background-color:#A40000;color:#fff;" onclick="realNameAuthentication()">客户确认/Generate
						Confirmation</button>
				</div>
			</div>
		</form>
	...
	<script type="text/javascript">
		function realNameAuthentication() {
			...
			window.location.href = "/kyc/apply_app.do";
		}
	</script>
</body>
</html>
