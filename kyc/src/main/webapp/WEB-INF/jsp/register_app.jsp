...
<body class="login tooltips"
			...
			<div class="form-group">
				<div style="margin-left:10%;margin-right:10%;margin-top:40px;">
					<button type="button" class="btn btn-lg btn-block"
						style="background-color:#128FEF;" onclick="createEID()">生成
						Generate</button>
				</div>
			</div>
		</form>
	...
	<script type="text/javascript">
		function createEID() {
			$("#publicKey")
					.val(
							"amm3Tx0RqSd4St+34UjlX2ILusFGc4xKh+3wrXSfmEkejnylA59QYW+aTL+rwrs5pX+DVLw9yqGzLPTfzxb+Yw==");
			$("#privateKey").val("**************");
			 //showDialog('confirm', '成功创建您专属E-PASS！你确定要这样操作么？', '提示消息', 400);
			 //alert("成功创建您专属E-PASS！");
