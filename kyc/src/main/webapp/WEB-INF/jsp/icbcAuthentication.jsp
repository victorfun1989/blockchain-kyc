...
<html lang="en">
	...
	function realNameAuthentication() {
		alert("实名认证成功，您已经获得工商银行所办法区块链数字身份证书！");
		window.location.href="/kyc/identity.do";
	}
</script>
	</head>
		...
		<div class="login-wrapper">
			<form role="form">
				<div class="form-group has-feedback lg left-feedback no-label">
				  <input type="text" class="form-control no-border input-lg rounded" placeholder="姓名" autofocus>
				  <span class="fa fa-male form-control-feedback"></span>
				</div>
				<div class="form-group has-feedback lg left-feedback no-label">
				  <input type="text" class="form-control no-border input-lg rounded" placeholder="身份证号">
				  <span class="fa fa-user form-control-feedback"></span>
				</div>
				<div class="form-group has-feedback lg left-feedback no-label">
				  <input type="text" class="form-control no-border input-lg rounded" placeholder="工商银行卡号">
				  <span class="fa fa-user form-control-feedback"></span>
				</div>
				<div class="form-group has-feedback lg left-feedback no-label">
				  <input type="text" class="form-control no-border input-lg rounded" placeholder="手机号">
				  <span class="fa fa-user form-control-feedback"></span>
				</div>
				<div class="form-group has-feedback lg left-feedback no-label">
				  <input type="text" class="form-control no-border input-lg rounded" placeholder="验证码">
				  <span class="fa fa-user form-control-feedback"></span>
				</div>
				<!-- 
				<div class="form-group has-feedback lg left-feedback no-label">
				...
				<div class="form-group">
				  <div class="checkbox">
					<label class="inline-popups">
					  <input type="checkbox" class="i-yellow-flat"> 我同意 <a href="#text-popup" data-effect="mfp-zoom-in">区块链数字身份认证相应条款</a>
					</label>
				  </div>
				</div>
				<div class="form-group">
					<button type="button" class="btn btn-warning btn-lg btn-perspective btn-block" onclick="realNameAuthentication()">发起实名认证</button>
				</div>
			</form>
		</div><!-- /.login-wrapper -->
