...
<title>Register | SENTIR - Responsive admin and dashboard UI
	kits template</title>
...
<body class="login tooltips"
	style="background-image:url(assets/img/register_bg.jpg);">
	...
	<div class="login-wrapper">
		<form role="form">
			...
			<div style="font-size:12px;">CIB于2017:03:11
				23:23:11申请使用您在区块链上的个人信息</div>
			<div style="font-size:12px;">At 2017:03:11 23:23:11, CIB apply
				to use your information recorded on the blockchain</div>

			<div class="form-group has-feedback lg left-feedback no-label">
				<textarea type="textarea" class="form-control input-lg "
					style="padding-left:0px;"> A+Lipg7l1Rj7panDrzfwbAERG1vtVqG+LhF5D2MG6y3HoPimYgCpkOZ0jvz1Dk7xza+PAGk4O0Dm
...
JSTPuP4CqJM3miPa6bkdLq5fo+zsqKqXqSGM6w== </textarea>
			...
			<div class="form-group">
				<div style="margin-left:10%;margin-right:10%;margin-top:40px;">
					<button type="button" class="btn btn-lg btn-block"
						style="background-color:#128FEF;" onclick="authentication()">授权/
						Authorization</button>
				</div>
			</div>

			<div style="font-size:12px;">您的个人信息为</div>
			<div style="font-size:12px;">your personal information is</div>

			<div class="has-feedback lg left-feedback no-label">
				<input type="text" class="form-control input-lg "
					style="padding-left:115px;" placeholder="" value="王五"> <span
					class="fa form-control-feedback "
					style="width:115px;font-weight:bold;color:#555;text-align:left;padding-left:5px;">姓名/Name</span>
			</div>
			<div class="has-feedback lg left-feedback no-label">
				<input type="text" class="form-control input-lg "
					style="padding-left:115px;" placeholder=""
					value="431381198109106573"> <span
					class="fa form-control-feedback"
					style="width:115px;font-weight:bold;color:#555;text-align:left;padding-left:5px;">身份证号/ID</span>
			</div>
			<div class="has-feedback lg left-feedback no-label">
				<input type="text" class="form-control input-lg "
					style="padding-left:115px;" placeholder="" value="184123123123">
				<span class="fa form-control-feedback"
					style="width:115px;font-weight:bold;color:#555;text-align:left;padding-left:5px;">手机号/Mobile</span>
			</div>
	...
	<script type="text/javascript">
		function authentication() {
			alert("您的个人信息已授权给兴业银行！");
			alert("您的E-PASS已成功获得兴业银行认证！");
			window.location.href = "/kyc/readfromblockchain.do";
		}
	</script>
</body>
</html>
